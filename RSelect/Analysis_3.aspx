<%@ page language="C#" autoeventwireup="true" inherits="Analysis, App_Web_hgk0_r_k" %>
            ...
            <div class="col-lg-2 col-md-2 col-xs-2 col-sm-2">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="" name="timeline" checked="checked" />
                                创新度 
                            </label>
                        </div>
                    </li>
                ...
                <div class="text-right">
                    <a href="Analysis.aspx" type="submit" class="btn btn-primary btn-block"><strong>确 定</strong></a>
                </div>
            </div>
                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="ptab1">
                                    <img src="img/scatter.png" width="500px" height="400px" />
                                </div>
                                        ...
                                        <table class="table table-bordered text-center table-striped">
                                            <thead class="text-center">
                                                <tr>
                                                    ...
                                                    <th class="text-center">创新度</th>
                                                    <th class="text-center">时效度</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
