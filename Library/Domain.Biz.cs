...
namespace Rselect
{
    ...
    public partial class Domain : Entity<Domain>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(Domain).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new Domain();
        //    entity.Name = "abc";
        //    entity.Insert();

        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(Domain).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        public static Domain FindByid(Int32 __id)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<Domain> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
