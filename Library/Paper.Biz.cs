...
namespace Rselect
{
    ...
    public partial class Paper : Entity<Paper>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(Paper).Name, Meta.Table.DataTable.DisplayName);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(Paper).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        public static Paper FindByid(Int32 __id)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<Paper> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
