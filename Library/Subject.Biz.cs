...
namespace Rselect
{
    ...
    public partial class Subject : Entity<Subject>
    {
        ...
        /// <summary>该Subject所对应的Domain</summary>
        [XmlIgnore]
        public Domain Domain
        {
            get
            {
                if (_Domain == null && DomainId > 0 && !Dirtys.ContainsKey("Domain"))
                {
                    _Domain = Domain.FindByid(DomainId);
                    Dirtys["Domain"] = true;
                }
                return _Domain;
            }
        ...
        /// <summary>该Subject所对应的DomainName</summary>
        [XmlIgnore]
        ...
        public static Subject FindByid(Int32 __id)
        {
            if (Meta.Count >= 1000)
        ...
        /// <summary>根据DomainId查找</summary>
        /// <param name="domainid"></param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Subject> FindAllByDomainId(Int32 domainid)
        {
            if (Meta.Count >= 1000)
